...
% Titel
\node  [name=titel,anchor=north east] at ([xshift=-1.5cm,yshift=-2.0cm]current page.north east) (komplx) {\fontsize{123}{50}\selectfont Complexity Theory};

\node [font=\Large,anchor=north east,align=right] at (komplx.south east) {Poster by Dr. Kai Sauerwald (Artificial Intelligence Group, FernUniversität in Hagen)\\based on a lecture by Prof. Dr. Schwentick (LogiDAC, TU Dortmund University)};
