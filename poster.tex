...
at (REACH.north west) 
{ 
	\textbf{\textsc{CNFCFGWORD}}  \hfill in $\mathbf{LOGCFL}$
};
...
\node (fPvsNP) [rotate=90, anchor=north west] at ([yshift=17cm] SatzAlternation.north west) {\fontsize{55}{33}\selectfont \textbf{Optimierung}};
