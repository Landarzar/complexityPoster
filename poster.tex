...
{ 
	...
	\textbf{Gegeben:} Variablenmenge $V$, Domäne $U$, Menge von Constraints $\mathcal{C}$ \newline
...
\node (littleOverview) [rotate=90, anchor=south west,align=left] at (HORNSAT.north east) {\fontsize{55}{33}\selectfont \textbf{Kleine}\\\fontsize{55}{33}\selectfont\textbf{Hierarchie}};
